	...
	<div class="col-sm-12">
		...
		<div class="alert alert-info">
			<?php
				...
				echo sprintf( _('Please refer to  <a href="%s" target="_blank"> <b>wiki</b> </a> for more information.'), "https://sangomakb.atlassian.net/wiki/spaces/PG/pages/26706045/PBX+GUI+-+AMI+Default+Configuration+in+16")."</p>";
